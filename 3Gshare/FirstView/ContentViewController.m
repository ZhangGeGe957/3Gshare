...
- (void)viewDidLoad {
    ...
    UIImage *touImage = [UIImage imageNamed:@"works_head.png"];
    ...
    _goodButton.frame = CGRectMake(260, 30, 60, 40);
    _lookButton.frame = CGRectMake(320, 30, 60, 40);
    _shareButton.frame = CGRectMake(380, 30, 60, 40);
    ...
    for (int i = 0; i < 3; i++) {
        ...
        aImageView.frame = CGRectMake(15, 130 + 210 * i, 400, 200);
    ...
    for (int i = 0; i < 2; i++) {
        ...
        UIImage *aImage = [UIImage imageNamed:imageName];
        UIImageView *aImageView = [[UIImageView alloc] initWithImage:aImage];
        aImageView.frame = CGRectMake(90, 760 + 400 * i, 250, 370);
        [_scrollView addSubview:aImageView];
    }
