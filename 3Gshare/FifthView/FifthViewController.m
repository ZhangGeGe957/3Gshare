...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 0) {
        ...
        personCell.desLabel.text = @"数媒/设计爱好者";
        personCell.sexLabel.text = @"开心了就笑，不开心了就过会再笑";
        ...
        setCell.bImageView.image = [UIImage imageNamed:@"img3.png"];
        return setCell;
    }
}
...
- (void)signOut {
    UIAlertController *tips = [UIAlertController alertControllerWithTitle:nil message:@"该需求被驳回！" preferredStyle:UIAlertControllerStyleAlert];
    [tips addAction:[UIAlertAction actionWithTitle:@"确定" style:UIAlertActionStyleDefault handler:nil]];
    [self presentViewController:tips animated:YES completion:nil];
}
