...
- (void)viewDidLoad {
    ...
    _timeOneArray = [[NSArray alloc] initWithObjects:@"15分钟前", @"20分钟前", @"30分钟前", @"1小时前", @"5小时前", nil];
    ...
    _scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 140, width, height - 100)];
    _scrollView.contentSize = CGSizeMake(width * 3, height - 100);
    _scrollView.pagingEnabled = YES;
    _scrollView.delegate = self;
    [self.view addSubview:_scrollView];
    
    _firstTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, width, height - 100) style:UITableViewStylePlain];
    ...
    _secondTableView = [[UITableView alloc] initWithFrame:CGRectMake(width, 0, width, height - 100) style:UITableViewStylePlain];
    ...
    _thirdTableView = [[UITableView alloc] initWithFrame:CGRectMake(width * 2, 0, width, height - 100) style:UITableViewStylePlain];
    ...
    [_segmentedControl insertSegmentWithTitle:@"上传时间" atIndex:0 animated:YES];
    [_segmentedControl insertSegmentWithTitle:@"推荐最多" atIndex:1 animated:YES];
    [_segmentedControl insertSegmentWithTitle:@"分享最多" atIndex:2 animated:YES];
