...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.row == 1) {
        DialogueViewController *dialogue = [[DialogueViewController alloc] init];
        dialogue.modalPresentationStyle = UIModalPresentationFullScreen;
        [self presentViewController:dialogue animated:YES completion:nil];
    }
}
